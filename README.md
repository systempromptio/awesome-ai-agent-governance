...
- [Mneme](https://github.com/MnemeHQ/mneme) - Architectural drift prevention for the AI SDLC: enforces repository architectural decisions (ADRs) as deterministic pre-action checks on AI coding agents' proposed changes.
