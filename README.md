...
- [AI Control Tower](https://github.com/kironovlaziz-del/AI-tower#readme) - Self-hosted AI governance platform providing policy enforcement, prompt masking (PII/NER), shadow AI monitoring, and MLOps lifecycle support. Apache-2.0.
